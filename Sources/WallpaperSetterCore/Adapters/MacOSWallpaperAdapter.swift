...
public struct MacOSWallpaperAdapter: WallpaperAdapter {
    ...
    public func validateImage(at url: URL) throws {
    ...
    public func applyWallpaper(from url: URL, to screens: [NSScreen]) throws {
        do {
    ...
    public func currentWallpaperURL(for screen: NSScreen) throws -> URL? {
